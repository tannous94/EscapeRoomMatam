...
namespace escaperoom {
    ...
    public:
        ...
        // Adds new Enigma to this escape room
        void addEnigma(const Enigma& enigma);

        // Removes an Enigma from this escape room
        void removeEnigma(const Enigma& enigma);

        // Gets the hardest enigma from this escape room
        Enigma getHardestEnigma();

        // Gets all enigmas in this escape room
        vector<Enigma>& getAllEnigmas();

        // Calls operator<< for base room.
        virtual void printRoom(std::ostream& output);

        // Returns a pointer for a base type room
        virtual EscapeRoomWrapper* cloneRoom();
